<!-- 
  Parakeet.vue 
    Renders SVG refs, paths and custom animation for the Parakeet Buddy.
-->
...
<template>
  <svg id="BIRD" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 931.96 884.34">
    <defs>
...
<style scoped>
  .lwing path{
    transform: scale(1, 1) translate(0px, -220px) rotateX(0deg) rotateY(0deg) rotateZ(0deg);
    animation: flapL 0.8s linear;
  }
  ...
  @keyframes flapL{
    ...
    20%,50%,80%{
      transform: scale(1, 0.8) translate(-100px, 700px) rotateX(150deg) rotateY(10deg) rotateZ(10deg);
    }
  }

  .lfoot path{
    transform: translate(0px, -200px) rotate(0deg);
    animation: stretchFootL 1.2s ease-in;
  }

  @keyframes stretchFootL{
    0%,100%{
      transform: translate(0px, -200px) rotate(0deg);
    }
    10%{
  ...
  .rwing path{
    transform: scale(1, 1) translate(120px, -300px) rotateX(0deg) rotateY(0deg) rotateZ(10deg);
    animation: flapR 0.8s linear;
  }

  @keyframes flapR{
    0%,30%,60%{
      transform:scale(1, 1)  translate(120px, -300px) rotateX(0deg) rotateY(0deg) rotateZ(0deg);
    }
    20%,50%,80%{
      transform: scale(1, 0.8) translate(-400px, 500px) rotateX(120deg) rotateY(10deg) rotateZ(10deg);
    }
  }

  .rfoot path{
    transform: translate(0px, -200px) rotate(0deg);
    animation: stretchFootR 1.2s ease-in;
  }

  @keyframes stretchFootR{
    0%,100%{
      transform: translate(0px, -200px) rotate(0deg);
    }
    15%{
      transform: translate(-300px, 200px) rotate(-28deg);
    }
  }

  .tail path{
    transform: translate(0px, -220px) rotate(0deg);
    animation: stretchTail 0.6s ease-in;
  }

  @keyframes stretchTail{
    0%,100%{
      transform: translate(0px, -220px) rotate(0deg);
    }
    15%{
      transform: translate(-300px, 160px) rotate(-28deg);
    }
  }
  ...
  .head ellipse, .head path:nth-of-type(14), .head path:nth-child(16), .head path:nth-of-type(15), .head path:nth-child(19),
  .head path:nth-child(23),.head path:nth-child(24), .head path:nth-child(25), .head path:nth-child(26){
