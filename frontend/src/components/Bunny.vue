<!-- 
  Bunny.vue 
    Renders SVG refs, paths and custom animation for the Bunny Buddy.
-->
...
<script setup>
    ...
    let once = false;
    const { variant } = useMotion(thebunny, {
      initial: {
        x: -40,
        y: 40,
      },
      enter: {
        ...
        transition: {
          duration: 200,
          onComplete: () => { variant.value = "bounceDown1" }
        },
      },
      bounceDown1: {
        x: 0,
      ...
      bounceUp: {
        ...
        transition: {
          duration: 300,
          onComplete: () => { variant.value = "bounceDown2" }
        },
      },
      bounceDown2: {
        x: -40,
...
<template>
  <svg id="BUNNY" ref="thebunny" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240.41 267.17">
    <g ref="backfootfar" class="backfootfar">
    ...
    <g ref="frontfootfar" class="frontfootfar">
    ...
    <g ref="frontfootnear" class="frontfootnear">
    ...
    <g ref="backfootnear" class="backfootnear">
    ...
    <g ref="head" class="head">
      <g ref="headfar" class="headfar">
...
<style scoped>
  .tail path{
    ...
    animation: shiftTail 5s ease-in-out infinite;
  }
  ...
  @keyframes shiftTail{
    ...
    10%,20%{
      transform: translate(-30px, -45px) rotate(3deg);
    }
  }

  .headfar path{
    transform: translate(-45px, -34px) rotate(0deg);
    animation: shiftMouth 5s ease-in-out infinite;
    animation-delay: 1.5s;
  }

  @keyframes shiftMouth{
    0%,8%,15%{
      transform: translate(-45px, -34px) rotate(0deg);
    }
    5%,11%{
      transform: translate(-50px, -28px) rotate(-2deg);
    }
  }

  .fluff path{
    transform: scaleX(1) translate(-45px, -34px) rotate(0deg);
    animation: shiftFluff 5s ease-in-out;
    animation-delay: 1s;
  }

  @keyframes shiftFluff{
    0%,25%,35%{
      transform: scaleX(1) translate(-45px, -34px) rotate(0deg);
    }
    15%,30%{
      transform: scaleX(1.005) translate(-45px, -34px) rotate(1deg);
    }
  }

  .nose path{
    transform: translate(-42px, -34px);
    animation: shiftNose 5s ease-in-out infinite;
    animation-delay: 1.5s;
  }
  ...
  @keyframes shiftNose{
    ...
    5%,11%{
      transform: translate(-55px, -15px) rotate(-4deg);
    }
  }

  .backfootnear path, .backfootfar path{
    transform: translate(-42px, -44px);
    animation: push1 0.3s ease-in-out 4;
  }

  .frontfootnear path, .frontfootfar path{
    transform: scaleY(0.9) translate(-42px, -24px);
    animation: push2 0.3s ease-in-out 4;
  }
  ...
  @keyframes push1{
    ...
    20%{
      transform: translate(170px, -70px) rotate(50deg);
    }
  }
  ...
  @keyframes push2{
    ...
    20%{
      transform: translate(-90px, 0px) rotate(-10deg);
    }
  }

  .bodytail{
    transform: translate(0px, -10px);
    animation: lift 0.3s ease-in-out 4;
  }
  ...
  @keyframes lift{
    ...
    20%{
      transform: scale(0.9) translate(100px, -44px) rotate(30deg);
    }
  }

  .lear{
    transform: translate(0px, 0px);
    animation: flap 0.3s ease-in-out 4;
  }
  ...
  @keyframes flap{
    ...
    40%{
      transform: translate(-20px, 120px) rotateX(120deg) rotateZ(-25deg);
    }
  }
